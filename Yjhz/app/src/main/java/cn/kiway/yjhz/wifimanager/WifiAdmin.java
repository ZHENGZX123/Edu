...
public class WifiAdmin {
	...
	public static WifiAdmin getDefault(Context context) {
		return mWifiAdmin == null ? mWifiAdmin = new WifiAdmin(context)
				: mWifiAdmin;
	}
	...
	public String getWifiMacAddress() {
		...
		try {
			if (null != mWifiInfo) {
				if (!TextUtils.isEmpty(mWifiInfo.getMacAddress()))
					macAddress = mWifiInfo.getMacAddress().replace(":", "");
				else
					return macAddress;
			}
		} catch (Exception e) {
