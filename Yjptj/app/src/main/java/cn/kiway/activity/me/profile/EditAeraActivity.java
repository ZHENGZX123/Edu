...
import cn.kiway.model.CityModel;
import cn.kiway.model.DistrictModel;
import cn.kiway.model.ProvinceModel;
import cn.kiway.utils.SharedPreferencesUtil;
import cn.kiway.utils.XmlParserHandler;
...
public class EditAeraActivity extends BaseActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.btn_confirm:
			...
			map.put("countyId", mCurrentProviceName + "*" + mCurrentCityName
