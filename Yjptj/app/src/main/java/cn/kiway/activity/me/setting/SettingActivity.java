...
public class SettingActivity extends BaseActivity implements
	...
	void initView() throws Exception {
		...
		cleanDialog = new ClearDataDialog(this, this, R.string.sure_clear_data,
				findViewById(R.id.clear));
		exitDialog = new ClearDataDialog(this, this, R.string.sure_exit,
	...
	public void onClick(View v) {
		...
		case R.id.about:
			...
			break;
		/*
		 * case R.id.set_number: // 设置安全号码 break; case R.id.changer_number: //
		 * 更换号码 break;
		 */
		case R.id.exit:
