...
public class StringUtil {
	 ...
	 * 时间戳转换为 **之前
	 * */
	public static int getStandardDate(long timeStr, long timeEnd) {
		long time = timeEnd - timeStr;
		long hour = (long) Math.ceil(time / 60 / 60 / 24 / 1000.0f);// 小时
	...
	public static String imgUrl(BaseActivity activity, String url) {
		String string;
		String s;
		if ("null".equals(url) || url == null || "".equals(url))
			return "";
